...
const els = document.querySelectorAll(".paying-attention-update-me");
els.forEach(el => {
  const data = JSON.parse(el.querySelector("pre").innerHTML);
  const root = react_dom_client__WEBPACK_IMPORTED_MODULE_2__.createRoot(el);
  root.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(App, {
    ...data
  }));
  el.classList.remove("paying-attention-update-me");
});
function App({
  question,
  answers,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, isCorrectDelayed && index === correctAnswer && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
