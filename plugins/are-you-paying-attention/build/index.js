...
(function () {
  ...
  wp.data.subscribe(function () {
    const results = wp.data.select("core/block-editor").getBlocks().filter(n => n.name === "ourplugin/are-you-paying-attention" && n.attributes.correctAnswer === undefined);
...
function EditComponent(props) {
  ...
  const handleChangeAlignment = val => setAttributes({
    theAlignment: val
  });
  const handleChangeBgColor = val => setAttributes({
    bgColor: val.hex
  });
  const handleChangeQuestion = val => setAttributes({
    question: val
  });
  ...
  const handleSubmitForm = () => setAttributes({
  ...
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_color__WEBPACK_IMPORTED_MODULE_4__.ChromePicker, {
    color: bgColor,
