            ...
            ?>
              <div class="event-summary">
                <a class="event-summary__date event-summary__date--beige t-center" href="<? the_permalink()?>">
                  ...
                  <span class="event-summary__day"><? the_time("m")?></span>
                </a>
                <div class="event-summary__content">
                  <h5 class="event-summary__title headline headline--tiny"><a href="<? the_permalink()?>"><? the_title()?></a></h5>
                  <p><? if(has_excerpt()) echo get_the_excerpt(); else echo wp_trim_words(get_the_content(), 10, "...")?> <a href="<? the_permalink()?>" class="nu gray">Read more</a></p>
                </div>
              </div>
